...
const SocialButton = styled.button`
  ...
  &:hover {
    background: ${props => props.color || '#1e3a8a'};
    color: #ffffff;
    border-color: ${props => props.color || '#1e3a8a'};
    ...
    '3': {
      ...
      content: `
        ...
        <div style="text-align: center; margin: 40px 0;">
          <img src="/insurtech/cer/award.webp" alt="Cybersecurity Company of the Year Award" style="max-width: 100%; height: auto; border-radius: 12px; box-shadow: 0 8px 30px rgba(30, 58, 138, 0.2);" />
        </div>
  ...
  return (
    <PageContainer>
      ...
      <HeroSection>
        ...
        <FloatingShape color="rgba(30, 58, 138, 0.15)" duration="12s" delay="2s" />
        <FloatingShape color="rgba(30, 64, 175, 0.1)" duration="14s" delay="4s" />
